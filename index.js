  ...
  try {
    await mailTransport.sendMail({
      ...
      html:
        ...
        '                                                            <td style="padding:0;Margin:0;padding-bottom:20px;padding-top:115px;font-size:0px"><img src="https://i.imgur.com/kKfOFNL.png" alt="Logo" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;font-size:12px" title="Logo" width="200" height="48"></td>\n' +
        '                                                            <td style="position: absolute;left: 0"><img src="https://i.imgur.com/JuRVpxa.png" alt="Logo" style="display:block;border:0;outline:none;text-decoration:none;font-size:12px;width: 100%" title="Logo"></td>\n' +
        "                                                        </tr>\n" +
        "                                                        <tr>\n" +
